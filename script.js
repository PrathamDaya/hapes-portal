...
// ══════════════════════════════════════════════════════════════
//  MUSIC PLAYER — YouTube IFrame API, fully custom UI
//  Playlist: PLg0uQzBdgt9kA8APLHj-4DBmidDksJFGx
// ══════════════════════════════════════════════════════════════
...
function onYTPlayerError(event) {
    ...
    document.getElementById('musicTitle').textContent = 'Playback error — check playlist visibility';
}
...
function updateMusicUI() {
    ...
    try {
        ...
        document.getElementById('musicArtist').textContent = data?.author || '♪ Your Playlist';
    } catch(e) {}
}
